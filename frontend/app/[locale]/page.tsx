...
import { NavigationBar, TaxiLogo } from "@/components/NavigationBar";
        ...
        <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: "1200px", margin: "0 auto", padding: "120px 24px 80px" }}>
          <div style={{ maxWidth: "660px" }}>
            ...
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "3rem" }}>
              ...
              <Show when="signed-in">
                <Link href="/customer/dashboard" className="btn-gold" style={{ fontSize: "1rem", padding: "1rem 2.25rem" }}>
                  Book a Ride <IconArrow />
                </Link>
              </Show>
          ...
          <div className="reveal glass-card" style={{ padding: "clamp(3rem,6vw,5rem) clamp(2rem,5vw,5rem)", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                ...
                <Show when="signed-in">
                  <Link href="/customer/dashboard" className="btn-gold" style={{ fontSize: "1.0625rem", padding: "1.0625rem 2.5rem" }}>
                    Book Your Next Ride <IconArrow />
                  </Link>
                </Show>
